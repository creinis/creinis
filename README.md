<p align="center">
  ...
  <img src="https://skillicons.dev/icons?i=bash,redis,postgres,py,django,git,mongodb,postman,sequelize&perline=13" />
  <br />
  <!-- Linha 2 – Backend avançado + libs complementares (Node.js, npm, jQuery, D3, etc.) -->
  <img src="https://skillicons.dev/icons?i=cs,express,sentry,nodejs,jquery,d3&perline=13" />
  <br />
  <!-- Linha 3 – Frontend moderno (React, Next.js, Tailwind, Bootstrap, etc.) -->
  <img src="https://skillicons.dev/icons?i=css,html,js,tailwind,bootstrap,reactmaterialui&perline=13" />
  <br />
  <!-- Linha 4 – DevOps, testes e deploy (Docker, Kubernetes, Jenkins, Prometheus, etc.) -->
  <img src="https://skillicons.dev/icons?i=sequelize,postman,docker&perline=13" />
  <br />
</p>
